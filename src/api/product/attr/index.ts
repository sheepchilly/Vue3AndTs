...
export const reqGetC2 = (category1Id:number|string)=>request.get<any,CategoryResponse>(API.C2_URL+category1Id)
export const reqGetC3 = (category2Id:number|string)=>request.get<any,CategoryResponse>(API.C2_URL+category2Id)
